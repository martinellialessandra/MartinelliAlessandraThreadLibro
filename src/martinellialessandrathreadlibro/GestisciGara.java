...
public class GestisciGara {
    ...
    public static void nuovaGaraHorror(){
        ...
        gara = new Gara(libriHorror);
    }
    
    public static void nuovaGaraFantasy(){
        ...
        gara = new Gara(libriFantasy);
    }
    
    public static void nuovaGaraDarkRomance(){
        ...
        gara = new Gara(libriDarkRomance);
    }
